...
#data = pd.read_csv("C:\\Users\\P70070487\\OneDrive - Maastro - Clinic\\cox-validation-ci-main\\cox-validation-ci-main\\cox_val_sparql\\cox_val_combined\\data_new_HN1.csv")
...
result = concordance_index_censored(data["event_overall_survival"], data["overall_survival_in_days"], data["lp_com"])
cindex = result[0]
